...
% 2. under the GNU Public License.
    ...
    xtick={1,...,\the\numexpr\rownumber+1},
    x tick label style={scale=0.4,font=\bfseries, rotate=90,align=center},
    y tick label style={scale=0.4,font=\bfseries},
    ylabel={Fitness},
    ylabel style={at={(0.1,.5)},anchor=north,scale=0.4,font=\bfseries},
    %ylabel style={scale=0.4,font=\bfseries},
    cycle list/Greys-6, 
    %cycle list shift=-3,
    colormap={myColor}{
        indices of colormap=(2,...,\pgfplotscolormaplastindexof{Greys-6} of Greys-6)},
    cycle list/.define={myColor}{[of colormap=myColor]},
    cycle list name=myColor,scale=1,
    %colormap={{217,217,217},{189,189,189},rgb{150,150,150}}
    ]
    ...
    \pgfplotsinvokeforeach{0,...,\rownumber}{
        ...
        \edef\temp{\noexpand\addplot+[,
            boxplot prepared={
                ...
                median=\myavg,
                every box/.style={solid,fill,opacity=0.7,draw=black,line width=1pt},
                every whisker/.style={solid,draw=black,line width=1pt },
                every median/.style={solid,draw=black,line width=1pt},
            }, 
            ]coordinates {};}
        \temp
    }
